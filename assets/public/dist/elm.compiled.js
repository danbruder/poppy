...
{
	if (region.aF.bQ === region.aP.bQ)
	{
		return 'on line ' + region.aF.bQ;
	}
	return 'on lines ' + region.aF.bQ + ' through ' + region.aP.bQ;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bL: 'hidden', bw: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bL: 'mozHidden', bw: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bL: 'msHidden', bw: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bL: 'webkitHidden', bw: 'webkitvisibilitychange' }
		: { bL: 'hidden', bw: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.bV, request.cv, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aS: fragment, aW: host, a2: path, a4: port_, a7: protocol, aD: query};
	});
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {B: frag, cb: params, A: unvisited, x: value, G: visited};
	});
...
var $author$project$Spa$Generated$Route$Upload = 2;
...
var $author$project$Spa$Generated$Pages$Upload__Model = function (a) {
	return {$: 2, a: a};
};
var $author$project$Spa$Generated$Pages$Upload__Msg = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Pages$NotFound$page = $author$project$Spa$Page$static(
	{cw: $author$project$Pages$NotFound$view});
var $author$project$Spa$Page$application = function (page) {
	return page;
};
var $author$project$Pages$Top$GotPhotos = function (a) {
	return {$: 0, a: a};
};
...
var $dillonkearns$elm_graphql$Graphql$Http$queryRequest = F2(
	function (baseUrl, query) {
		return {
			...
			bE: $dillonkearns$elm_graphql$Graphql$Document$decoder(query),
			bK: _List_Nil,
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{br: false, bt: r.bt, bE: r.bE, bK: r.bK, bV: r.bV, cp: r.cp, cs: r.cs, cv: r.cv}));
};
var $elm$http$Http$riskyRequest = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{br: true, bt: r.bt, bE: r.bE, bK: r.bK, bV: r.bV, cp: r.cp, cs: r.cs, cv: r.cv}));
};
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {bN: index, bT: match, b5: number, cl: submatches};
	});
...
var $dillonkearns$elm_graphql$Graphql$Document$Hash$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {I: charsProcessed, K: hash, F: seed, P: shift};
	});
...
var $dillonkearns$elm_graphql$Graphql$Document$Hash$finalize = function (data) {
	var acc = (!(!data.K)) ? (data.F ^ A2(
		...
		A2(
			...
			15,
			A2($dillonkearns$elm_graphql$Graphql$Document$Hash$multiplyBy, $dillonkearns$elm_graphql$Graphql$Document$Hash$c1, data.K)))) : data.F;
	var h0 = acc ^ data.I;
...
var $dillonkearns$elm_graphql$Graphql$Document$Hash$hashFold = F2(
	function (c, data) {
		var res = data.K | ((255 & $elm$core$Char$toCode(c)) << data.P);
		var _v0 = data.P;
		if (_v0 === 24) {
			return {
				I: data.I + 1,
				K: 0,
				F: A2($dillonkearns$elm_graphql$Graphql$Document$Hash$mix, data.F, res),
				P: 0
			};
		} else {
			return {I: data.I + 1, K: res, F: data.F, P: data.P + 8};
		}
	});
	...
	function (forceMethod, url, queryParams, maybeOperationName, queryDocument) {
		...
		if (_Utils_eq(
			...
			return {
				...
				bV: 1,
				cv: A2($dillonkearns$elm_graphql$Graphql$Http$QueryParams$urlWithQueryParams, _List_Nil, url)
			};
		} else {
			return {bt: $elm$http$Http$emptyBody, bV: 0, cv: urlForGetRequest};
		}
	});
...
var $dillonkearns$elm_graphql$Graphql$Http$GraphqlError$GraphqlError = F3(
	function (message, locations, details) {
		return {ai: details, bS: locations, bU: message};
	});
...
var $dillonkearns$elm_graphql$Graphql$Http$toReadyRequest = function (_v0) {
	...
	if (!_v1.$) {
		...
		return {
			...
			bz: $dillonkearns$elm_graphql$Graphql$Http$decoderOrError(request.bE),
			bK: request.bK,
			bV: function () {
				var _v2 = queryRequestDetails.bV;
				if (!_v2) {
					return 'GET';
				} else {
					return 'Post';
		...
		return {
			...
			bV: 'POST',
			cp: request.cp,
			cv: A2($dillonkearns$elm_graphql$Graphql$Http$QueryParams$urlWithQueryParams, request.C, request.U)
		};
	}
};
...
var $dillonkearns$elm_graphql$Graphql$Http$send = F2(
	function (resultToMessage, fullRequest) {
		var request = fullRequest;
		return (request.H ? $elm$http$Http$riskyRequest : $elm$http$Http$request)(
			A2($dillonkearns$elm_graphql$Graphql$Http$toHttpRequestRecord, resultToMessage, fullRequest));
	});
var $author$project$GraphqlClient$makeRequest = F2(
...
var $author$project$Queries$PhotosList$Payload = function (photos) {
	return {aa: photos};
};
...
var $author$project$Data$Photo$Photo = function (url) {
	return {cv: url};
};
...
var $author$project$Juniper$Object$Photo$publicUrl = A4($dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField, 'String', 'publicUrl', _List_Nil, $elm$json$Json$Decode$string);
...
var $author$project$Queries$PhotosList$photoSelection = A2(
	$dillonkearns$elm_graphql$Graphql$SelectionSet$with,
	$author$project$Juniper$Object$Photo$publicUrl,
	$dillonkearns$elm_graphql$Graphql$SelectionSet$succeed($author$project$Data$Photo$Photo));
...
var $author$project$Juniper$Query$photos = function (object____) {
	return A4(
...
var $author$project$Queries$PhotosList$query = A2(
	$dillonkearns$elm_graphql$Graphql$SelectionSet$map,
	$author$project$Queries$PhotosList$Payload,
	$author$project$Juniper$Query$photos($author$project$Queries$PhotosList$photoSelection));
var $author$project$Queries$PhotosList$run = function (toMsg) {
	return A2($author$project$GraphqlClient$makeRequest, toMsg, $author$project$Queries$PhotosList$query);
};
var $author$project$Pages$Top$init = F2(
	function (shared, _v0) {
		var params = _v0.cb;
		return _Utils_Tuple2(
			{aa: _List_Nil, O: $elm$core$Maybe$Nothing},
			$author$project$Queries$PhotosList$run($author$project$Pages$Top$GotPhotos));
	});
...
var $author$project$Pages$Top$PressedControl = function (a) {
	return {$: 4, a: a};
};
var $author$project$Pages$Top$PressedLetter = function (a) {
	return {$: 3, a: a};
};
var $author$project$Pages$Top$toKey = function (string) {
	var _v0 = $elm$core$String$uncons(string);
	if ((!_v0.$) && (_v0.a.b === '')) {
		var _v1 = _v0.a;
		var _char = _v1.a;
		return $author$project$Pages$Top$PressedLetter(_char);
	} else {
		return $author$project$Pages$Top$PressedControl(string);
	}
};
var $author$project$Pages$Top$keyDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Pages$Top$toKey,
...
var $author$project$Pages$Top$subscriptions = function (model) {
	return $elm$browser$Browser$Events$onKeyDown($author$project$Pages$Top$keyDecoder);
};
...
var $author$project$Pages$Top$ClickedSelectedPhoto = {$: 2};
...
var $author$project$Pages$Top$viewPhotoInBlackroom = function (photo) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('inset-0 fixed p-10 bg-gray-900 bg-opacity-95'),
				$elm$html$Html$Events$onClick($author$project$Pages$Top$ClickedSelectedPhoto)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('flex justify-center items-center h-full w-full')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src(photo.cv)
							]),
						_List_Nil)
					]))
			]));
};
var $author$project$Pages$Top$viewBlackroom = function (model) {
	return A2(
		$elm$core$Maybe$withDefault,
		A2($elm$html$Html$span, _List_Nil, _List_Nil),
		A2($elm$core$Maybe$map, $author$project$Pages$Top$viewPhotoInBlackroom, model.O));
};
var $author$project$Pages$Top$ClickedPhoto = function (a) {
	return {$: 1, a: a};
};
var $author$project$Pages$Top$viewPhoto = function (photo) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('h-56 m-1'),
				$elm$html$Html$Events$onClick(
				$author$project$Pages$Top$ClickedPhoto(photo))
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Pages$Top$viewPhotos = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('flex flex-wrap m-1 pt-4 px-4')
			]),
		A2($elm$core$List$map, $author$project$Pages$Top$viewPhoto, model.aa));
};
var $author$project$Pages$Top$view = function (model) {
	return {
		bt: _List_fromArray(
			[
				$author$project$Pages$Top$viewPhotos(model),
				$author$project$Pages$Top$viewBlackroom(model)
			]),
		cq: 'Top'
	};
};
var $author$project$Pages$Top$page = $author$project$Spa$Page$application(
	{bO: $author$project$Pages$Top$init, bR: $author$project$Pages$Top$load, ch: $author$project$Pages$Top$save, cm: $author$project$Pages$Top$subscriptions, cu: $author$project$Pages$Top$update, cw: $author$project$Pages$Top$view});
var $author$project$Spa$Page$element = function (page) {
	return {
		bO: F2(
			function (_v0, params) {
				return page.bO(params);
			}),
		bR: $elm$core$Basics$always(
			A2($elm$core$Basics$composeR, $elm$core$Basics$identity, $author$project$Spa$Page$ignoreEffect)),
		ch: $elm$core$Basics$always($elm$core$Basics$identity),
		...
		cu: F2(
			function (msg, model) {
				return A2(page.cu, msg, model);
			}),
		cw: page.cw
	};
};
var $author$project$Pages$Upload$Model = F4(
	function (hover, previews, files, key) {
		return {aj: files, Y: hover, bP: key, aC: previews};
	});
var $author$project$Pages$Upload$init = function (_v0) {
	var params = _v0.cb;
	var key = _v0.bP;
	return _Utils_Tuple2(
		A4($author$project$Pages$Upload$Model, false, _List_Nil, _List_Nil, key),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Pages$Upload$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Pages$Upload$GotFiles = F2(
	function (a, b) {
		return {$: 3, a: a, b: b};
	});
var $author$project$Pages$Upload$GotPreviews = function (a) {
	return {$: 4, a: a};
};
...
var $author$project$Pages$Upload$UploadedFile = function (a) {
	return {$: 5, a: a};
};
...
var $author$project$Pages$Upload$upload = function (files) {
	return $elm$http$Http$request(
		{
			bt: $elm$http$Http$multipartBody(
				A2(
					$elm$core$List$map,
					$elm$http$Http$filePart('files[]'),
					files)),
			bE: $elm$http$Http$expectWhatever($author$project$Pages$Upload$UploadedFile),
			bK: _List_Nil,
			bV: 'POST',
			cp: $elm$core$Maybe$Nothing,
			cs: $elm$core$Maybe$Nothing,
		...
		switch (msg.$) {
			...
			case 3:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							aj: A2($elm$core$List$cons, file, files),
							Y: false
						}),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								A2(
								$elm$core$Task$perform,
								$author$project$Pages$Upload$GotPreviews,
								$elm$core$Task$sequence(
									A2(
										$elm$core$List$map,
										$elm$file$File$toUrl,
										A2($elm$core$List$cons, file, files)))),
								$author$project$Pages$Upload$upload(
								A2($elm$core$List$cons, file, files))
							])));
			case 4:
				var urls = msg.a;
			...
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{aj: _List_Nil, aC: _List_Nil}),
					A2($author$project$Utils$Route$navigate, model.bP, 0));
		}
	});
var $author$project$Pages$Upload$DragEnter = {$: 1};
var $author$project$Pages$Upload$DragLeave = {$: 2};
...
var $author$project$Pages$Upload$dropDecoder = A2(
	$elm$json$Json$Decode$at,
	_List_fromArray(
		['dataTransfer', 'files']),
	A2($elm$json$Json$Decode$oneOrMore, $author$project$Pages$Upload$GotFiles, $elm$file$File$decoder));
var $author$project$Pages$Upload$hijack = function (msg) {
...
var $author$project$Pages$Upload$hijackOn = F2(
	function (event, decoder) {
		return A2(
			$elm$html$Html$Events$preventDefaultOn,
			event,
			A2($elm$json$Json$Decode$map, $author$project$Pages$Upload$hijack, decoder));
	});
var $elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var $elm$html$Html$Attributes$style = $elm$virtual_dom$VirtualDom$style;
var $author$project$Pages$Upload$viewDropzone = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				'border',
				model.Y ? '6px dashed purple' : '6px dashed #ccc'),
				...
				A2(
				$author$project$Pages$Upload$hijackOn,
				'dragenter',
				$elm$json$Json$Decode$succeed($author$project$Pages$Upload$DragEnter)),
				A2(
				$author$project$Pages$Upload$hijackOn,
				'dragover',
				$elm$json$Json$Decode$succeed($author$project$Pages$Upload$DragEnter)),
				...
				$author$project$Pages$Upload$hijackOn,
				'dragleave',
				$elm$json$Json$Decode$succeed($author$project$Pages$Upload$DragLeave)),
				A2($author$project$Pages$Upload$hijackOn, 'drop', $author$project$Pages$Upload$dropDecoder)
			]),
		_List_fromArray(
			[
				(!$elm$core$List$length(model.aj)) ? A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Pages$Upload$Pick),
						$elm$html$Html$Attributes$class('bg-indigo-600 text-white p-1 px-3 rounded cursor-pointer')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('bg-indigo-600 opacity-50 text-white p-1 px-3 rounded cursor-pointer')
					]),
				_List_fromArray(
					[
...
var $author$project$Pages$Upload$view = function (model) {
	return {
		bt: _List_fromArray(
			[
				$author$project$Pages$Upload$viewDropzone(model)
			]),
		cq: 'Upload'
	};
};
var $author$project$Pages$Upload$page = $author$project$Spa$Page$element(
	{bO: $author$project$Pages$Upload$init, cm: $author$project$Pages$Upload$subscriptions, cu: $author$project$Pages$Upload$update, cw: $author$project$Pages$Upload$view});
	...
	function (params, key, url) {
		return {
			...
			aD: A2(
				$elm$core$Maybe$withDefault,
				$elm$core$Dict$empty,
				A2($elm$core$Maybe$map, $author$project$Spa$Url$toQueryDict, url.aD)),
			a8: url
		};
	});
...
var $author$project$Spa$Generated$Pages$upgrade = F3(
	function (toModel, toMsg, page) {
			...
			function (params, shared) {
				return A3(
					...
					A2(
						page.bO,
						shared,
						A3($author$project$Spa$Url$create, params, shared.bP, shared.cv)));
			});
		...
		return {V: bundle_, bO: init_, cu: update_};
	});
var $author$project$Spa$Generated$Pages$pages = {
	an: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$NotFound__Model, $author$project$Spa$Generated$Pages$NotFound__Msg, $author$project$Pages$NotFound$page),
	as: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Top__Model, $author$project$Spa$Generated$Pages$Top__Msg, $author$project$Pages$Top$page),
	at: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Upload__Model, $author$project$Spa$Generated$Pages$Upload__Msg, $author$project$Pages$Upload$page)
};
var $author$project$Spa$Generated$Pages$init = function (route) {
	switch (route) {
		case 0:
			return $author$project$Spa$Generated$Pages$pages.as.bO(0);
		case 1:
			return $author$project$Spa$Generated$Pages$pages.an.bO(0);
		default:
			return $author$project$Spa$Generated$Pages$pages.at.bO(0);
	}
};
...
var $author$project$Spa$Generated$Pages$bundle = function (bigModel) {
	switch (bigModel.$) {
		case 0:
			...
			return $author$project$Spa$Generated$Pages$pages.as.V(model);
		case 1:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.an.V(model);
		default:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.at.V(model);
	}
};
var $author$project$Spa$Generated$Pages$subscriptions = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).cm(0);
};
...
var $author$project$Spa$Document$toBrowserDocument = function (doc) {
	return {bt: doc.bt, cq: doc.cq};
};
var $elm$browser$Browser$Navigation$load = _Browser_load;
var $author$project$Spa$Generated$Pages$load = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).bR(0);
};
var $author$project$Spa$Generated$Pages$save = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).ch(0);
};
			...
			switch (_v0.a.$) {
				case 0:
					if (!_v0.b.$) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.as.cu, msg, model);
					} else {
						break _v0$3;
					}
				case 1:
					if (_v0.b.$ === 1) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.an.cu, msg, model);
					} else {
						break _v0$3;
					}
				default:
					if (_v0.b.$ === 2) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.at.cu, msg, model);
					} else {
						break _v0$3;
					}
			}
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('w-full border-b border-gray-300 flex justify-between')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('p-6 flex items-center font-bold ')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('mx-2 link'),
													$elm$html$Html$Attributes$href(
													$author$project$Spa$Generated$Route$toString(0))
												]),
											_List_fromArray(
												[
													$elm$html$Html$text('Poppy Photos')
												]))
										])),
									A2(
									$elm$html$Html$div,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('p-6 flex items-center')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('mx-2 link'),
													$elm$html$Html$Attributes$href(
													$author$project$Spa$Generated$Route$toString(2))
												]),
											_List_fromArray(
												[
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('mx-2 w-8 h-8 rounded-full'),
													$elm$html$Html$Attributes$src('https://danbruder.com/js/../static/myface-d07c1438362080b352d2ef803d3b3f8c.jpeg')
												]),
											_List_Nil)
										]))
								])),
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		...
		b7: $author$project$Main$UrlChanged,
		b8: $author$project$Main$LinkClicked,
		cm: $author$project$Main$subscriptions,
		cu: $author$project$Main$update,
		cw: A2($elm$core$Basics$composeR, $author$project$Main$view, $author$project$Spa$Document$toBrowserDocument)
	});
